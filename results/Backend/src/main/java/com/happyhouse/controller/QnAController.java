...
import com.happyhouse.model.service.QnAService;
...
public class QnAController {
    ...
    @ApiOperation(value = "질문 번호에 해당하는 질문글의 정보를 반환한다.", response = QnA.class)    
	@GetMapping("{qnaNo}")
    ...
    @ApiOperation(value = "새로운 질문글 정보를 입력한다. 그리고 DB입력 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
	@PostMapping
    ...
    @ApiOperation(value = "질문글번호에 해당하는 질문글의 정보를 수정한다. 그리고 DB수정 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
	@PutMapping("{qnaNo}")
    ...
    @ApiOperation(value = "질문글번호에 해당하는 질문글의 정보를 삭제한다. 그리고 DB삭제 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
	@DeleteMapping("{qnaNo}")
